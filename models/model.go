...
type MessageAutoDeleteTimerChanged struct { 
    MessageAutoDeleteTime int `json:"message_auto_delete_time,omitempty"` //New auto-delete time for messages in the chat
}
 
//VoiceChatScheduled This object represents a service message about a voice chat scheduled in the chat.
type VoiceChatScheduled struct { 
    StartDate int `json:"start_date,omitempty"` //Point in time (Unix timestamp) when the voice chat is supposed to be started by a chat administrator
}
 
//VoiceChatEnded This object represents a service message about a voice chat ended in the chat.
type VoiceChatEnded struct { 
    Duration int `json:"duration,omitempty"` //Voice chat duration; in seconds
}
...
type ChatMemberOwner struct { 
    ...
    CustomTitle string `json:"custom_title,omitempty"` //Custom title for this user
...
type ChatMemberAdministrator struct { 
    ...
    CanManageVoiceChats bool `json:"can_manage_voice_chats,omitempty"` //True, if the administrator can manage voice chats
...
type ChatMemberRestricted struct { 
    ...
    UntilDate int `json:"until_date,omitempty"` //Date when restrictions will be lifted for this user; unix time
}
...
type SetMyCommands struct { 
    ...
    Scope *BotCommandScopeDefault `json:"scope"` //A JSON-serialized object, describing scope of users for which the commands are relevant. Defaults to BotCommandScopeDefault.
...
type GetMyCommands struct { 
    Scope *BotCommandScopeDefault `json:"scope"` //A JSON-serialized object, describing scope of users. Defaults to BotCommandScopeDefault.
...
type CreateNewStickerSet struct { 
    ...
    TgsSticker string `json:"tgs_sticker"` //TGS animation with the sticker, uploaded using multipart/form-data. See https://core.telegram.org/animated_stickers#technical-requirements for technical requirements
